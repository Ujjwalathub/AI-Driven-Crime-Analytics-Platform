...
async def load_data():
    ...
    try:
        ...
        try:
            ...
            print("Warning: criminals_enriched.csv not found, falling back to criminals.csv")
        ...
        try:
            ...
            print("Warning: incidents_time_engineered.csv not found, falling back to incidents.csv")
